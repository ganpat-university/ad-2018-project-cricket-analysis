...
def FetchData():
    ...
    btn.place(relx=0.5,rely=0.7, relheight=0.1, relwidth=0.1)
...
def Img1():
    r = Toplevel()
    r.title("BarGraph")
    canvas = Canvas(r, height=500, width=1000)
    canvas.pack()
    widget = Label(r, text='The previous history of shots played by batsman', fg='red')
